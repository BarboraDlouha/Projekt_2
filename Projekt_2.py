...
def validate_guess_number(guessed_number):
    """ 
...
def calculate_bulls_and_cows(secret_number, guessed_number):
    ...
    Args:
    -secret_number (list of int): The secret number generated by the program.
    -guessed_number (list of int)): The user's guessed number.
